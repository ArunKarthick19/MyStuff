...
const GanttChart = () => {
  ...
  // const selectedFlight = [ //Ignore, not working 
  //   {
...
const actualEnd    = toDate(t.actual_end);
    ...
    const fmt = (d) => (d ? d.toLocaleString("en-SG", { hour: "2-digit", minute: "2-digit" }) : "N/A");
    ...
    <div>
      ...
      >
        <p>
          ...
          <br />
           Clickk and drag on the Gantt chart area to view more
           <br/>
          <strong>NB arrival</strong>
        </p>
        <div
          style={{
...
const milestoneTemplates = [
  {
    id: "4",
    name: "4. Door 2 Security - Security",
    planned_end: -15,
    anchor: "eibt",
    aircraftTypes: ["NB"],
    dependsOn: [],
  ...
  {
    id: "10",
    name: "10. RSM MAB(PLB activation time) - Ramp",
    planned_end: -10,
    anchor: "eibt",
    aircraftTypes: ["NB"],
    dependsOn: [],
  ...
  },
  {
    ...
    // actual_end: 0
          ...
          {
    id: "20",
    name: "20. Unloading Start & End - Ramp",
    planned_start:+3,
    planned_end: +30,
    anchor: "aibt",
    aircraftTypes: ["NB"],
    ...
    // actual_end: 0
            ...
            {
    id: "7",
    name: "7. Unloading Start & End - Cabin Svc",
    planned_start:+5,
    planned_end: +30,
    anchor: "aibt",
    aircraftTypes: ["NB"],
    ...
    // actual_end: 0
             ...
             {
    id: "18",
    name: "18. First and last trip start (to arrival belt) - Baggage",
    planned_start:+10,
    planned_end: +25,
    anchor: "aibt",
    aircraftTypes: ["NB"],
